...
def test_create_job(client, normal_user_token_headers):
    ...
    response = client.post(url="/job/create-job", data=json.dumps(data), headers=normal_user_token_headers)
...
def test_retreive_job_by_id(client, normal_user_token_headers):
    ...
    client.post(url="/job/create-job", data=json.dumps(data), headers=normal_user_token_headers)
